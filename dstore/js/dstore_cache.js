...
dstore_cache.cmd = function (argv) {
    ...
    else if (argv._[1] == "iati") {
        dstore_cache.iati(argv);
    }
    else if (argv._[1] == "empty") {
        dstore_cache.empty(argv);
    }
    else if (argv._[1] == "newold") {
...
dstore_cache.datastore = function (argv) {
    ...
    try {
        fs.mkdirSync(global.argv.cache);
    } catch (e) {
    }
...
dstore_cache.newold = function (argv) {
    ...
    try {
        fs.mkdirSync(global.argv.cache + "/new");
    } catch (e) {
    }
    try {
        fs.mkdirSync(global.argv.cache + "/old");
    } catch (e) {
    }
